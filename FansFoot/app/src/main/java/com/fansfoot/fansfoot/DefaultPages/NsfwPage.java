...
//                handler.postDelayed(runable, 2000);
        ...
        CheckBox refresh = (CheckBox) view.findViewById(R.id.cm_nsfwToolBar_Refesh);
        ...
        recyclerViewAdapter = new NsfwRecycleViewAdapter(context,posts);
